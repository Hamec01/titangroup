...
- **Дефекты наблюдения D1a/D1b/D2/D4/D5/D6 — задеплоены и отчитаны; образы R15-D7 A→F физически
  развёрнуты** к 2026-09-03 (каждый swap отдельно разрешён владельцем). Текущий prod-образ
  `titanor-time-app:d7f-d216482`, схема **100/100**. Все деплои — web-only swap, только A и D2 несли
  миграцию (98→99→100). 2026-09-03 — **технический** sign-off по коду/деплоям A→F.
  **Указание владельца 2026-09-04:** Deploy F не считать production-live до отдельного отчёта
  `R15_D7_DEPLOY_F_PROD_REPORT_RU.md` + ревью; production без явного разрешения не менять.
