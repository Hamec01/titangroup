...
**Статус 2026-08-30: DEPLOYED + PASS.** Пилот на `titanor-time-app:t97-pilot-edd950c` (image swap,
без миграции; владелец запустил `deploy-edd950c.sh` — DEPLOY OK, production unchanged). Отчёт
`R09_UX_REPORT_RU.md`, план+объём `R09_UX_AUDIT_AND_PLAN_RU.md`, browser-чек-лист
`R09_BROWSER_ACCEPTANCE_RU.md`. **Объём сужен владельцем 2026-08-30: весь FOREMAN
