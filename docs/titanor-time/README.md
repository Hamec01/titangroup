...
Все пять документов, включая этот README — **версия 5.4.1** (2026-07-23), каждый самодостаточен: для
понимания текущего состояния не требуется открывать более ранние версии.
