...
состоянии. Образы R15-D7 A→F физически развёрнуты на production (каждый swap отдельно разрешён
владельцем). **Указание владельца 2026-09-04:** Deploy F и запись «Что нового» в `/guide`
(`c76d439`, в работающем образе её нет) **не считать production-live** до отдельного отчёта
