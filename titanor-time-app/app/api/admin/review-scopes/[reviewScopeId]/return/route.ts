...
// docs/titanor-time/04_ADMIN_FIRST_API_CONTRACTS.md §8 — POST /api/admin/review-scopes/:reviewScopeId/return.
// `proposals[]` is accepted by the contract but not yet implemented (see lib/review-scopes.ts) —
// a non-empty array is rejected with a clear VALIDATION_ERROR, not silently dropped.
