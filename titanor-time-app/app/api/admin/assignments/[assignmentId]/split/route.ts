...
// the per-employee advisory lock nor demoted an overlapping prior primary, so splitting a PRIMARY
// assignment left two overlapping-period primary rows and, once Migration 2 lands, the create
// fails against ex_site_assignment_one_primary_per_period with 23P01 → 500. It was also
// untested/incomplete and had no UI caller.
//
