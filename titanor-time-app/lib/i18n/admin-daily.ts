...
const EN = {
  ...
  workers: {
    ...
    create: 'Create worker', notFound: 'No worker found with this id.', backToday: 'Back to Today',
    activeEmployment: 'Active employment', employmentEnded: 'Employment ended', report: 'View time report',
    locations: 'View Check In/Out locations on map', currentAssignments: 'Current assignments',
...
const RU = {
  ...
  workers: {
    ...
    create: 'Создать работника', notFound: 'Работник с таким идентификатором не найден.', backToday: 'Вернуться на «Сегодня»',
    activeEmployment: 'Работает', employmentEnded: 'Работа завершена', report: 'Открыть отчёт по времени',
    locations: 'Показать места Check In/Out на карте', currentAssignments: 'Текущие назначения',
