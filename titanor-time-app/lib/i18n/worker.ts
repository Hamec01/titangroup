...
export interface WorkerStrings {
  ...
  // R15 fixroad F03 — calm note on the clock screen when the current site is flagged "GPS often unavailable here"
  gpsOftenUnavailableSiteNote: string;
...
export const WORKER_STRINGS: Record<AppLocale, WorkerStrings> = {
  EN: {
    errOutsideGeofence: "You're outside the site area. Move closer and sync again.",
    ...
    statusZoneOutside: 'You are outside the site',
    statusZoneNearBoundary: 'Near the boundary — the event will be reviewed',
    statusZoneLowAccuracy: 'Weak GPS signal — the event will be reviewed',
  ...
  RU: {
    errOutsideGeofence: 'Вы находитесь за пределами территории объекта. Подойдите ближе и синхронизируйте снова.',
    ...
    statusZoneOutside: 'Вы вне объекта',
