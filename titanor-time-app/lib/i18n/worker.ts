...
export const WORKER_STRINGS: Record<AppLocale, WorkerStrings> = {
  EN: {
    ...
    statusZoneNearBoundary: 'Near the boundary — under review',
    statusZoneLowAccuracy: 'Weak GPS signal — under review',
  ...
  RU: {
    ...
    statusZoneNearBoundary: 'Около границы — на проверке',
    statusZoneLowAccuracy: 'Слабый сигнал GPS — на проверке',
