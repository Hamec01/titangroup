...
function drawStampPage(doc: PDFKit.PDFDocument, locale: AppLocale, generatedAtHelsinki: string): void {
  ...
  doc.font('DejaVu').fontSize(8.5).fillColor('#444444').text(t(locale, 'Generated by Titanor Time', 'Сформировано в Titanor Time'), boxX, stampY + 108, { width: boxWidth, align: 'center' });
  doc.text(generatedAtHelsinki, boxX, stampY + 122, { width: boxWidth, align: 'center' });
  doc.fillColor('#000000');
