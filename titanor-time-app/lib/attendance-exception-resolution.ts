...
const DOMAIN_ALLOWED_ACTIONS: Record<ExceptionTypeFilter, string[]> = {
  ...
  OUTSIDE_GEOFENCE_CHECKIN: ['ACKNOWLEDGE_AS_VALID', 'DISMISS'],
...
const ACKNOWLEDGE_ALLOWED_TYPES = new Set<ExceptionTypeFilter>(['GPS_NOT_VERIFIED', 'OUTSIDE_GEOFENCE_CHECKIN', 'OUTSIDE_GEOFENCE_CHECKOUT', 'SITE_MISMATCH_CHECKOUT', 'GEOFENCE_VERSION_MISMATCH', 'EXCESSIVE_CLOCK_SKEW', 'EXCESSIVE_SHIFT_DURATION', 'PERIOD_BOUNDARY_SPAN']);
